...
class C(BaseConstants):
    ...
    PAYOUT_1 = 20
    PAYOUT_2 = 100
    INTRO_DELAY = Lexicon.lex_timePreferences_delay_3
...
class Intro(Page):
    ...
    def error_message(player: Player, values):
        ...
        error_messages = dict(
            practice=Lexicon.lex_error_not_correct_selection
        )
...
class TimePreferences(Page):
    ...
    def vars_for_template(player):
        ...
        return dict(
            delay=getattr(
                Lexicon, 'lex_timePreferences_delay_%s' % newer_delay['delay'][(
                    player.round_number - 1)]['delay']
            ),
            Lexicon=Lexicon,
            **which_language
        )
